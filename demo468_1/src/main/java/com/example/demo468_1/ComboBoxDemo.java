...
public class ComboBoxDemo extends Application {
    ...
    private ImageView[] flagImage = {new ImageView("image/canada.png"),
            new ImageView("image/china.png"),
            new ImageView("image/denmark.png"),
            new ImageView("image/france.jpg"),
            new ImageView("image/germany.svg"),
            //new ImageView("image/india.gif"),
           // new ImageView("image/norway.gif"),
            new ImageView("image/uk.webp"), new ImageView("image/us.gif")};
